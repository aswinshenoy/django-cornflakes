...
from .utils import create_global_sequence, create_shard_id_function
...
class ShardedIDField(BaseShardIDField, BigAutoField):
    ...
    def db_type(self, connection, *args, **kwargs):
        ...
        if connection.vendor == PostgresDatabaseWrapper.vendor:
            ...
            return super(ShardedIDField, self).db_type(connection)
